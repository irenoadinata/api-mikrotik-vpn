							...
							<tbody>
								...
								foreach ($pool as $data) {
									...
									<tr>
										...
										<th><?= $data['ranges']; ?></th>
										<th>
											<a href="<?= site_url('ppp/delPool/' . $id) ?>" onclick="return confirm('Apakah Anda Yakin Akan Hapus Profile <?= $data['name']; ?> ?')"><i class="fa fa-trash" style="color:red"></i></a>
	...
	<div class="modal fade" id="modal-add-pool" style="display: none;" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content bg-warning">
				...
				<form action="<?= site_url('ppp/addppppool') ?>" method="POST">
	...
	<div class="modal fade" id="modal-edit" style="display: none;" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content bg-warning">
				...
				<form action="<?= site_url('ppp/editppppool') ?>" method="POST">
					<div class="modal-body">
						<div class="form-group">
							<label for="name">Name</label>
